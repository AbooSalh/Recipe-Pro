...
export function TagManagement({
  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-[#CBD5E1] mb-4">
      ...
      />
      <SelectedTags selectedTags={selectedTags} onRemoveTag={onRemoveTag} />
      <AvailableTags
...
export function RecipeCard({ recipe }: RecipeCardProps) {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden border border-[#CBD5E1]">
      <Image
        src={recipe.image}
        alt={recipe.name}
        width={400}
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {recipe.tags.map((tag) => (
            <Badge key={tag} className="bg-[#E2E8F0] text-[#475569] rounded-lg">
              {tag}
            </Badge>
          ))}
        </div>
...
// Main RecipeCollection Component
